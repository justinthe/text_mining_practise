...
ap.add_argument('-o', '--output', default='result.txt', help='output filename')
ap.add_argument('-m', '--multiplier', default='1.3', help='threshold multiplier')
...
try:
    text_str = open(infile, encoding='utf-8').read()
except IOError:
